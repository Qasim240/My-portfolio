...
import mettingImag from "../../assets/img/project/project-need.jpg"
const Metting = () => {
  return (
      ...
      <div className="container">
        <div className="row g-4 align-items-center">
            ...
            <div className="pro__metting__content">
              ...
              >
                ...
                <span className="box">
                  ...
                  <a href="#0">New Green Town Faisalabad, Paksitan</a>
                </span>
              </div>
            </div>
          </div>
          <div className="col-lg-5">
            ...
            >
              <img className="rounded-5" src={mettingImag} alt="img" />
            </div>
          </div>
        </div>
      </div>
