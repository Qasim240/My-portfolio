        ...
        <div className="sub__contact-left d-grid">
          <div className="sub__contac-item">
            <div className="content">
              ...
              <span className="textp">New Green Town Faisalabad, Pakistan</span>
            </div>
          </div>
          <div className="sub__contac-item">
            <div className="content">
              <span className="address d-block"> email </span>
              <Link className="textp">muhammadqasim1014@gmail.com</Link>
            </div>
          </div>
          <div className="sub__contac-item">
            <div className="content">
              <span className="address d-block"> call now </span>
              <Link className="textp">0304-1695609</Link>
            </div>
          </div>
        </div>
          ...
          <ul className="social d-flex gap-3">
            {socialIcons.map(({ icon, id }) => (
              <li key={id}>
                ...
                <a href="https://www.linkedin.com/in/muhammad-qasim-4468aa190?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
