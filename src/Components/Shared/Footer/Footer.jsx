          ...
          <div className="row g-4">
            <div className="col-lg-6">
              <div className="get__content">
                <p>
                  Hello, I’m Qasim, Website & User Interface developer
                  based in Pakistan.
                </p>
                <a href="#0">muhammadqasim1014@gmail.com</a>
              </div>
            </div>
            <div className="col-lg-6">
                  ...
                  {socalList.map(({ id, icon, platfrom }) => {
                    return (
                      <div key={id} className="col-lg-6 col-md-6 col-sm-6">
                        <a href="https://www.linkedin.com/in/muhammad-qasim-4468aa190?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="social__footer">
                          {platfrom}
                          <i>{icon}</i>
                        </a>
                      </div>
